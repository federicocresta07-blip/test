...
const RIVER_PLAYERS: readonly SamplePlayer[] = [
  { id: 'riv-1', name: 'Maximiliano Ibarra', position: 'POR', level: 84, age: 30, traits: { calidad: 84, portero: 85 }, experience: 78 },
  { id: 'riv-2', name: 'Lucas Peralta', position: 'LD', level: 80, age: 27, traits: { resistencia: 87, pase: 84 }, secondary: ['ED'] },
  { id: 'riv-3', name: 'Emiliano Racedo', position: 'DFC', level: 83, age: 29, traits: { agresividad: 87, calidad: 84, entradas: 86 }, experience: 76 },
  { id: 'riv-4', name: 'Nahuel Sosa', position: 'DFC', level: 81, age: 24, traits: { velocidad: 80, entradas: 83 } },
  { id: 'riv-5', name: 'Tomás Vidal', position: 'LI', level: 79, age: 26, traits: { velocidad: 85, pase: 81 }, secondary: ['EI'] },
  { id: 'riv-6', name: 'Julián Correa', position: 'MCD', level: 82, age: 31, traits: { pase: 82, entradas: 86 }, experience: 85, consistency: 78 },
  { id: 'riv-7', name: 'Miguel Fernández', position: 'MC', level: 84, age: 28, traits: { calidad: 88, pase: 89 }, consistency: 80 },
  { id: 'riv-8', name: 'Bruno Aguirre', position: 'MC', level: 79, age: 22, traits: { resistencia: 86, calidad: 84 }, consistency: 48 },
  { id: 'riv-9', name: 'Facundo Rivas', position: 'ED', level: 83, age: 25, traits: { velocidad: 89, regate: 88, pase: 84 } },
  { id: 'riv-10', name: 'Gonzalo Arriaga', position: 'DC', level: 87, age: 27, traits: { remate: 92, tiro: 86, calidad: 88 }, consistency: 76 },
  { id: 'riv-11', name: 'Iván Mendoza', position: 'EI', level: 81, age: 23, traits: { velocidad: 88, regate: 86 }, consistency: 52 },
  // Banco
  ...
  { id: 'riv-16', name: 'Diego Alcaraz', position: 'MCO', level: 78, age: 24, traits: { calidad: 84, tiro: 86 }, secondary: ['MC', 'SD'] },
  { id: 'riv-17', name: 'Pedro Salas', position: 'ED', level: 75, age: 20, secondary: ['EI'], consistency: 40 },
  { id: 'riv-18', name: 'Hernán Ledesma', position: 'DC', level: 77, age: 33, traits: { agresividad: 84 }, experience: 90 },
];

const RACING_PLAYERS: readonly SamplePlayer[] = [
  { id: 'rac-1', name: 'Federico Ojeda', position: 'POR', level: 80, age: 33, traits: { portero: 82 }, experience: 88 },
  { id: 'rac-2', name: 'Marcos Duarte', position: 'LD', level: 77, age: 25, traits: { velocidad: 84 } },
  { id: 'rac-3', name: 'Leandro Páez', position: 'DFC', level: 81, age: 28, traits: { agresividad: 86, entradas: 85 } },
  { id: 'rac-4', name: 'Cristian Molina', position: 'DFC', level: 78, age: 30, traits: { calidad: 82 } },
  { id: 'rac-5', name: 'Ezequiel Ferrer', position: 'LI', level: 76, age: 23, traits: { resistencia: 85 } },
  { id: 'rac-6', name: 'Rodrigo Iriarte', position: 'MCD', level: 79, age: 29, traits: { agresividad: 80, entradas: 84 } },
  { id: 'rac-7', name: 'Sebastián Ayala', position: 'MC', level: 78, age: 26, traits: { resistencia: 84, pase: 83 } },
  { id: 'rac-8', name: 'Franco Bazán', position: 'MCO', level: 82, age: 24, traits: { calidad: 86, regate: 85, tiro: 84 }, consistency: 58 },
  { id: 'rac-9', name: 'Nicolás Roldán', position: 'ED', level: 79, age: 27, traits: { velocidad: 88 } },
  { id: 'rac-10', name: 'Damián Sarmiento', position: 'DC', level: 82, age: 31, traits: { agresividad: 84, remate: 86, calidad: 83 }, experience: 82 },
